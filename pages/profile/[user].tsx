    ...
    return (
        <div className="relative">
            <div className="bg-gradient-to-r from-[#FF6969] to-[#FF4747] relative overflow-hidden px-[12%] py-[120px] lg:py-[80px] sm:py-[65px] xs:py-[50px]">  
                <img src="/lines3.svg" alt="lines" className="right-0 -bottom-5 absolute md:scale-50 md:opacity-30 md:-bottom-[4rem] md:-right-[3rem]"/>
            </div>
                ...
                <div className="max-w-[2320px] mx-auto flex gap-20 lg:gap-10 sm:gap-3">
                    ...
                    <div className="flex flex-col gap-3 text-white pt-10 lg:pt-5 xs:pt-2 xs:gap-1">
                        ...
                        <div className="flex gap-2 font-[300] text-[18px] lg:text-[16px] xs:text-[12px] xs:flex-col xs:gap-0">
                            <span>Data dołączenia: 20.02.2012</span>
                        </div>
                    </div>
                </div>
            </div> 
    ...
    return (
        <div className="text-mediumDark">
            <div className="flex flex-col gap-[2rem] sm:gap-[1rem]">
                <span className="font-[700] text-[32px] sm:text-[28px]">
                    Ogłoszenia
                </span>
                <span className="font-[300] text-[18px] w-1/2 lg:w-full sm:text-[16px]">
                    Lorem Ipsum is simply dummy text of the printing and printer. Lorem Ipsum is simply dummy text of the printing and printer. Lorem Ipsum is simply dummy text of the printing and printer.
                </span>
                ...
                <NextLink href='/post/create' passHref >
                    <Button as="a" className="w-full hidden md:block bg-primaryPink text-white hover:bg-secondaryPink hover:text-primaryPink active:bg-[#ffb8b8] active:text-white focus:bg-primaryPink focus:text-white">
                        Dodaj ogłoszenie
                    </Button>
                </NextLink>
            </div>
    ...
    return (
        <>
            ...
            <main className="bg-[#F4F4F4]">
                <UserBaner />
                <div className="xxxl:min-h-screen max-w-[2320px] mx-auto py-[8rem] px-[10%] sm:px-[5%] sm:py-[4rem] lg:py-[6rem]">
